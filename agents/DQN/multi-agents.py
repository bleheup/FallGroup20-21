...
os.mkdir(path)
validate=True
title = "Rainbow DQN testing winrates agaisnt discernible agents"
labels = ["Base Rush", "Cycle BRush 25", "Cycle BRush 50", "All Cycle", "Cycle Target Node", "Same Commands", "Swarm Agent"]
# validate = sys.argv[len(sys.argv) - 1]
# if validate == "-v":
#     validate = True
# else:
#     title = "Rainbow DQN training winrates agaisnt random actions"
#     validate = False
