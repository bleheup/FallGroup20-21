...
if __name__ == '__main__':
    ...
    sac_player = AgentDiscreteSAC( input_dims=input_shape, env=env, n_actions=n_actions, action_space=n_actions, player_num=player_num, map_name=map_name )
    players = {
        0: rand_player,
        1: sac_player
    }
    names = [rand_player.__class__.__name__, sac_player.__class__.__name__]
